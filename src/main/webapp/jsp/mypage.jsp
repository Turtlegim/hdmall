            ...
            <article class="top_fullbg">
                ...
                <div class="myhd_firinfo">
                    <div class="myinfo">
                        ...
                        <a href="join.html" onclick="sendJoin()">회원정보 수정</a>
                    </div>
                    <div class="mypresent">
                        <dl>
                                    ...
                                    <table>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>243</td>
                                                <td>이용안내</td>
                                                <td class="tl"><a href="javascript:fnMngBbcDetail('7024');"
                                                        class="tover">캘빈클라인 브랜드 퇴점 안내</a></td>
                                            ...
                                            <tr>
                                                <td>242</td>
                                                <td>이용안내</td>
                                                <td class="tl"><a href="javascript:fnMngBbcDetail('6962');"
                                                        class="tover">[공지] H.Point Web 리뉴얼 작업으로 인한 서비스 이용 부분적 제한 안내 </a>
                                                </td>
                                            ...
                                            <tr>
                                                <td>240</td>
                                                <td>이용안내</td>
                                                <td class="tl"><a href="javascript:fnMngBbcDetail('6863');"
                                                        class="tover">[공지] ALIPAY, WECHAT PAY 결제수단 오류 안내</a></td>
                                            ...
                                            <tr>
                                                <td>239</td>
                                                <td>이용안내</td>
                                                <td class="tl"><a href="javascript:fnMngBbcDetail('6862');"
                                                        class="tover">보나쥬르 브랜드 퇴점 안내</a></td>
                                                <td class="gray">2021-11-09</td>
                                            ...
                                            <tr>
                                                <td>238</td>
                                                <td>이용안내</td>
                                                <td class="tl"><a href="javascript:fnMngBbcDetail('6842');"
                                                        class="tover">엠브라리오 브랜드 퇴점 안내</a></td>
                                            ...
                                            <tr>
                                                <td>237</td>
                                                <td>이용안내</td>
                                                <td class="tl"><a href="javascript:fnMngBbcDetail('6802');"
                                                        class="tover">[공지] 온라인몰 사이트 일시 중단 예정 공지</a></td>
                                            ...
                                            <tr>
                                                <td>235</td>
                                                <td>이용안내</td>
                                                <td class="tl"><a href="javascript:fnMngBbcDetail('6722');"
                                                        class="tover">셀라피 브랜드 퇴점 안내</a></td>
